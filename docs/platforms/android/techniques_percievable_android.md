...
This can be achieved by following the [Labels or instruction](techniques_understandable_android#labels-or-instructions-wcag-332---level-a) and [Error identification](techniques_understandable_android#error-identification-wcag-331---level-a) guidelines.
